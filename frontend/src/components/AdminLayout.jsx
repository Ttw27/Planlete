...
import { LogOut, Image as ImageIcon, Type, ExternalLink, Users, LifeBuoy, FlaskConical, ShoppingBag, PenTool, ShieldAlert, Zap, Sparkles, Pencil, Timer, FileJson, Ticket } from "lucide-react";
...
export default function AdminLayout({ children, title }) {
  ...
  const nav = [
    ...
    { to: "/admin/plan-json", label: "Plan JSON", icon: <FileJson size={16} /> },
    { to: "/admin/promo", label: "Promo codes", icon: <Ticket size={16} /> },
    { to: "/admin/plan-builder", label: "Manual plan builder", icon: <PenTool size={16} /> },
    { to: "/admin/edit-plan", label: "Edit a plan", icon: <Pencil size={16} /> },
    { to: "/admin/loading-preview", label: "Loading preview", icon: <Timer size={16} /> },
    { to: "/admin/security", label: "Security", icon: <ShieldAlert size={16} /> },
    { to: "/admin/activity-standards", label: "Activity standards", icon: <Sparkles size={16} /> },
