...
const SLIDES = [
  ...
  },
  {
    ...
    fallback: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&q=80",
    caption: "Plyometrics and power development built around sprint mechanics",
  },
  {
    imageKey: "sprinter_carousel_3",
    fallback: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&q=80",
    caption: "Gym sessions designed to transfer power to the track",
  },
  {
    imageKey: "sprinter_carousel_4",
    fallback: "https://images.unsplash.com/photo-1594882645126-14ac19a0c6e7?w=800&q=80",
