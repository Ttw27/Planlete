...
const LONGEVITY_DATA = {
  ...
  days: [
    { day: "Mon", label: "Strength A", focus: "Lower + core", workouts: [
      { name: "Goblet Squat", sets: "3x12", load: "Moderate", rest: "90s" },
      { name: "Romanian Deadlift", sets: "3x10", load: "Moderate", rest: "90s" },
      { name: "Walking Lunge", sets: "3x10 each", load: "Light-mod", rest: "60s" },
      { name: "Dead Bug", sets: "3x10", load: "Bodyweight", rest: "45s" },
      { name: "Plank", sets: "3x45s", load: "Bodyweight", rest: "30s" },
    ]},
    ...
    { day: "Wed", label: "Rest / Mobility", focus: "Active recovery", workouts: [
      ...
      { name: "Hip flexor stretch", sets: "2x60s each", load: "Bodyweight", rest: "30s" },
      { name: "Thoracic rotation", sets: "2x10", load: "Bodyweight", rest: "30s" },
    ]},
    { day: "Thu", label: "Strength B", focus: "Upper + posture", workouts: [
      { name: "DB Bench Press", sets: "3x12", load: "Moderate", rest: "90s" },
      { name: "Cable Row", sets: "3x12", load: "Moderate", rest: "90s" },
      { name: "DB Shoulder Press", sets: "3x12", load: "Light-mod", rest: "60s" },
      { name: "Face Pull", sets: "3x15", load: "Light", rest: "45s" },
      { name: "Farmers Carry", sets: "3x30m", load: "Moderate", rest: "90s" },
    ]},
    { day: "Fri", label: "Zone 2 + Strength", focus: "Combined", workouts: [
      { name: "Cycle or Row", sets: "25min", load: "65% HRmax", rest: "—" },
      { name: "Trap Bar Deadlift", sets: "3x8", load: "Moderate", rest: "2min" },
      { name: "Step-up", sets: "3x10 each", load: "Light", rest: "60s" },
    ]},
...
export default function LongevityApp() {
  return <AppShell data={LONGEVITY_DATA} />;
}
