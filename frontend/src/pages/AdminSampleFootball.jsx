...
export default function AdminSampleFootball() {
  ...
  const [formData, setFormData] = useState({
    ...
    bullets: [
      ...
      "Explosiveness and acceleration for match performance",
      "In-season phase training (weeks 1–4 peak)",
      "Position-specific positioning and tactical focus",
    ],
    slides: [
      {
        image_key: "football_carousel_1",
        image_url: null,
        caption: "Off-season — rebuild base fitness and strength",
      },
      {
        image_key: "football_carousel_2",
        image_url: null,
        caption: "Pre-season — football-specific conditioning and pitch work",
      },
      {
        image_key: "football_carousel_3",
        image_url: null,
        caption: "In-season — maintain without fatigue. MD-1, MD, MD+1 structure",
      },
      {
        image_key: "football_carousel_4",
        image_url: null,
  ...
  const handleImageUpload = async (slideIndex, file) => {
    ...
    try {
      ...
      const key = `sample_football_${slideIndex}`;
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto p-8">
        ...
        <h1 className="font-display text-5xl uppercase mb-4">Football Sample Plan</h1>
