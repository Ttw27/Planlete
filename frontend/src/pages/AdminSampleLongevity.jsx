...
export default function AdminSampleLongevity() {
  ...
  const [formData, setFormData] = useState({
    ...
    bullets: [
      ...
      "Posture and joint durability focus",
      "Energy systems and cardiovascular conditioning",
      "Sustainable training for life",
    ],
    slides: [
      {
        image_key: "longevity_carousel_1",
        image_url: null,
        caption: "Four days per week — sustainable, effective, built around life",
      },
      {
        image_key: "longevity_carousel_2",
        image_url: null,
        caption: "Mobility and joint health built into every session",
      },
      {
        image_key: "longevity_carousel_3",
        image_url: null,
        caption: "Anti-inflammatory nutrition — foods that work for you long term",
      },
      {
        image_key: "longevity_carousel_4",
        image_url: null,
  ...
  const handleImageUpload = async (slideIndex, file) => {
    ...
    try {
      ...
      const key = `sample_longevity_${slideIndex}`;
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto p-8">
        ...
        <h1 className="font-display text-5xl uppercase mb-4">Longevity & Fitness Sample Plan</h1>
