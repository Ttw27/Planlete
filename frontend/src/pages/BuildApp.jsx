...
export const BASE_QUESTIONS = [
  ...
  },
  {
    ...
    hint: "The other input every calorie estimate needs.",
    showIf: (a) => (a.nutrition || "").toLowerCase().startsWith("yes"),
  },
  {
    id: "daily_activity",
    ...
    type: "choice",
    options: [
      "Desk job, not much walking",
      "On my feet a fair bit",
      "Physical job, moving all day",
    ],
    hint: "This shifts your daily calories more than most people expect.",
    showIf: (a) => (a.nutrition || "").toLowerCase().startsWith("yes"),
  },
  {
    id: "diet",
