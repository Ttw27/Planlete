...
export const CONTENT_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      { key: "progressive_overline", label: "Overline", default: "Built around your sport" },
      { key: "progressive_headline_a", label: "Headline line 1", default: "Not a template with" },
      { key: "progressive_headline_b", label: "Headline line 2 (accent)", default: "your sport's name on it." },
      { key: "progressive_point1_title", label: "Point 1 title", default: "Programmed for your sport, specifically" },
      { key: "progressive_point1_body", label: "Point 1 body", default: "A footballer gets eccentric hamstring work and Copenhagen planks, because that's what the injury data says footballers need. A boxer gets neck strengthening and rotational power. Same app, a completely different plan — because the demands aren't the same.", long: true },
      { key: "progressive_point2_title", label: "Point 2 title", default: "Built for how you actually train" },
      { key: "progressive_point2_body", label: "Point 2 body", default: "Training on your own? You'll never be handed a drill that needs a partner or a team. Playing Saturdays? Your hard sessions won't land on match day. Carrying an injury? We train around it and leave that area alone.", long: true },
      { key: "progressive_point3_title", label: "Point 3 title", default: "Four weeks, not one — and it keeps going" },
      { key: "progressive_point3_body", label: "Point 3 body", default: "Three weeks building, then a deload to recover, then it cycles again with your own logged numbers setting the new targets. You can see all four weeks from the day you get it.", long: true },
      { key: "progressive_point4_title", label: "Point 4 title", default: "Every exercise explained, nothing thrown in at random" },
      { key: "progressive_point4_body", label: "Point 4 body", default: "Tap any exercise to see exactly why it's there — for your goal, your experience, your injury. And if the name means nothing to you, a demo is one tap away.", long: true },
      { key: "progressive_point5_title", label: "Point 5 title", default: "Checked before it reaches you" },
      { key: "progressive_point5_body", label: "Point 5 body", default: "Every plan runs through automated checks first: only equipment you actually have, sessions that fit the time you said you've got, a genuine deload week, and nothing requiring a training partner if you train alone.", long: true },
    ],
  },
  {
    id: "sports",
